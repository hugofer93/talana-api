...
AUTHENTICATION_BACKENDS = [
    'talana.apps.core.backends.EmailAuthBackend',
]
...
EMAIL_BACKEND += '.console.EmailBackend' if DEBUG else '.smtp.EmailBackend'

EMAIL_HOST = config('EMAIL_HOST', default='mail.talana.com')

EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)

EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='hola@talana.com')
